...
| `RSA-OAEP-256`       | RSAES-OAEP using SHA-256 and MGF1 with SHA-256 | RSA-OAEPのSHA-256版                   |
...
| `ECDH-ES+A128KW`     | ECDH-ES + AES-128 Key Wrap                     | ECDH-ES + AES-128鍵ラップ             |
| `ECDH-ES+A192KW`     | ECDH-ES + AES-192 Key Wrap                     | ECDH-ES + AES-192鍵ラップ             |
| `ECDH-ES+A256KW`     | ECDH-ES + AES-256 Key Wrap                     | ECDH-ES + AES-256鍵ラップ             |
| `A128GCMKW`          | AES GCM Key Wrap with 128-bit key              | AES-GCMによる鍵ラップ（128bit）       |
| `A192GCMKW`          | AES GCM Key Wrap with 192-bit key              | AES-GCMによる鍵ラップ（192bit）       |
| `A256GCMKW`          | AES GCM Key Wrap with 256-bit key              | AES-GCMによる鍵ラップ（256bit）       |
| `PBES2-HS256+A128KW` | PBES2 with HMAC SHA-256 and A128KW             | パスワードベースの鍵暗号化（SHA-256） |
| `PBES2-HS384+A192KW` | PBES2 with HMAC SHA-384 and A192KW             | パスワードベースの鍵暗号化（SHA-384） |
| `PBES2-HS512+A256KW` | PBES2 with HMAC SHA-512 and A256KW             | パスワードベースの鍵暗号化（SHA-512） |
