...
`authorization_response_iss_parameter_supported` は RFC 8414 の Authorization Server Metadata、および OpenID Connect Discovery の Provider Configuration Response に含められる Boolean 型パラメータである。
