...
2025年9月の AuthZEN WG は、**12月の Gartner IAM Summit（2025年12月8〜10日、テキサス州 Grapevine）でのインターオペラビリティデモ公表** に向けた準備活動が議論の中心であった。9月4日・11日・18日・25日の4回の定例コールに加え、9月5日・9日には Gartner デモ準備のための専用セッションが追加開催され、ML 投稿数も37件と通常月の2倍近くに達した。
...
`openid/authzen` リポジトリの2025年9月の活動: **新規 issue 1件**（#375）、**PR 13本**（うち merge 8本・close 3本・依存性更新 dependabot 6本含む）。技術議論が活発だった主要 PR を以下に整理する。
...
なお `dependabot[bot]` による依存性更新 PR（axios・vite・form-data・brace-expansion 関連で計6本、いずれも9月17日マージ）は技術議論を伴わないため詳細は割愛する。
...
10月末〜11月初開催予定の IETF 124 Montreal で OAuth WG の議論が予想されており、Salim BOU ARAM の OpenID Connect Email Account Linking Extension ドラフトが認可・アカウント統合の文脈で言及される可能性が9月末時点で示唆されていた。
