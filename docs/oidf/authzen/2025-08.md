...
| PR   | タイトル                                                                              | 起票者         | マージ日   |
| ---- | ------------------------------------------------------------------------------------- | -------------- | ---------- |
| #347 | Update authorization-api-1_0.md security section                                      | identitymonk   | 8 月 19 日 |
...
- **到達した合意**: PR #355（メタデータ節）と PR #347（Security 節）が 8 月 19 日に立て続けにマージされ、Issue #268 と #300 が事実上クローズ
...
- **結末**: Brossard が同日合意。PR #347 として 8 月 19 日マージ
...
- **8 月 21 日 David Brossard（クローズ判断）**: 「**これはより大きな作業項目で、1.0 以降に処理する**」と明示してクローズ
...
8 月 7 日コール議事録に「Authenticate Conference のセッションが accept された」と記録されており、David Brossard・Omri Gazitt・Ian Glazer が登壇予定として確認された。Authenticate Conference は FIDO Alliance が主催する年次 ID イベントで、10 月にカーニバル・カリブのカルロスベイで開催される（具体的な発表内容の準備は 9 月以降に持ち越し）。
...
- [PR #345 Add JSON-LD support](https://github.com/openid/authzen/pull/345) — 8 月 21 日 post-1.0 として close
