...
R&E WG 単独のセッションは公開告知からは確認できなかったが、Working Group Updates の枠で各 WG の進捗共有が行われる構成である。Mike Jones は自身のブログ（[OpenID Presentations at April 2026 OpenID Workshop and IIW](https://self-issued.info/?p=2845)）で、4 月 27 日のワークショップで "OpenID Connect Working Group Update" を担当したと報告している。
...
- [OpenID Presentations at April 2026 OpenID Workshop and IIW – Mike Jones](https://self-issued.info/?p=2845) — Mike Jones による登壇報告
