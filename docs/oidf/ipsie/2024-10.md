...
- **10/8 (火)**: IPSIE WG の **インオーガル（最初の）コール** を開催。Aaron Parecki (Okta) が議長を務め、Mike Leszcz (OIDF Director of Operations) を含む 6 名が参加。アンチトラスト方針の確認とチャーター概観、エンタープライズ ID の outcomes ブレインストーミングを実施。10/15 週の定例は IETF Dublin / IIW など関連イベントとの競合により休止することを決定し、次回を 10/22 とした
...
- 10/15 週の定例は IETF Dublin / IIW 等との競合により **休止**。次回は 10/22
