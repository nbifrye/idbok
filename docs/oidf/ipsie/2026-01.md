...
1月の ML アーカイブ (`https://lists.openid.net/pipermail/openid-specs-ipsie/2026-January/`) には週次ファイルが3件存在するが（Week-of-Mon-20260112: 749 bytes、Week-of-Mon-20260119: 1 KB、Week-of-Mon-20260126: 755 bytes）、ファイルサイズが極めて小さく個別メッセージ URL も 404 を返したため内容を取得できなかった。ファイルサイズから判断すると、各週の投稿は定例コールのアジェンダ通知・会議録リンク告知等に限られていた模様で、本格的な技術議論はミーティングおよび GitHub Issues を通じて行われていた。
...
- [openid-specs-ipsie ML アーカイブ (2026-January)](https://lists.openid.net/pipermail/openid-specs-ipsie/2026-January/) - 対象月のスレッド一覧（個別メッセージは取得不可）
