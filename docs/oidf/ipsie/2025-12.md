...
_作業ストリーム構造の確認_: Aaron Parecki が作業体制を **IPSIE Core**・**SL\*（セッションレベル）**・**AL\*（保証レベル）** の3軸で整理し、それぞれを OIDF・IETF・Kantara の適切な標準化機関に分配するフレームを提示した。グループはセキュリティレベル定義を OIDF 内に留めることを確認した。
