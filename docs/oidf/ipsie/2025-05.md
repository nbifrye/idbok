...
2. **NIST SP800-63C Rev4 ドラフトと SL1 のギャップ整理**: Dean H. Saxe が PR #71 で FAL2 関連要件を一括して文書化し、5/8 にギャップ単位で Issue #75〜#84 の 10 件を起票。後の 6 月の FAL2 系 Issue 集中起票（#86〜#95）と sidecar 文書構想の **直接の前提** となった
...
- **AuthCon**: 5 月の WG コール内で Dick Hardt が `Less Oopsie with IPSIE` というタイトルで登壇したと報告（5/20 議事録より）。具体的な開催日・場所はコール議事録には記録されていないが、IPSIE への外部認知を高める発表と位置付けられた
