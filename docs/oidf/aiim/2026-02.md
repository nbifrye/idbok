...
AIIM CG のメーリングリスト（openid-aiim）の公開アーカイブは週単位のインデックスで提供されている。2026年2月分として記録されているのは 2月16日週と 2月23日週であり、以下の主要スレッドが確認できる。

### 2 月 16 日週

- **[Feedback on NIST Feedback](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260216/)** — 2026-02-17、投稿者: Flemming Andreasen (Cisco)、返信: Chris Phillips。Threat Modelling サブグループによる NIST-2025-0035 への回答文書のドラフトに関する議論。Andreasen は NIST が追加で公開した概念文書「Accelerating the Adoption of Software and AI Agent Identity and Authorization」（コメント期限 2026-04-02）にも言及し、現行回答文書の内容が新概念文書にも流用可能だが追加検討を要すると指摘した。スレッド内では 2月19日のサブグループ討議、2月24日のドラフト最終化、3月9日の NIST への提出スケジュールが共有されている。
- **[Agenda for tomorrow's call: MCP profile of AuthZen](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260216/)** — 2026-02-17、投稿者: Atul Tulshibagwale（共同議長）、返信: Sai Srungaram、Gail Hodges。翌 2月18日の AIIM CG コールのアジェンダとして (1) AI とアイデンティティに関する最新ニュース (10分)、(2) MCP Profile for AuthZen の紹介（Atul、20分）、(3) AOB が案内された。
- **[Making MCP COAZ - slides](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260216/)** — 2026-02-19、投稿者: Atul Tulshibagwale。前日のコールで発表したスライド「Making MCP COAZ.pdf」が共有された（本文は簡潔なカバーメッセージ、スライドは PDF 添付）。

### 2 月 23 日週

- **[Feedback on NIST Feedback](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260223/)** — 2026-02-25、投稿者: Lukasz Jaromin、返信: Gail Hodges。NIST 回答ドラフトに対するコメント継続。
- **OIDF AIIM CG サブグループ ミーティング招待（Use Cases / Threat Modeling / Taxonomy）** — 投稿者: Atul Tulshibagwale。2月25日〜26日にかけて、三つのサブグループそれぞれのミーティング招待および定期開催案内が ML に送付された。
- **["[un]prompted - The AI Security Practitioner Conference - March 3rd / March 4th"](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260223/)** — 2026-02-26、投稿者: Jeff Lombardo。翌月開催予定の AI セキュリティ実務者カンファレンスが周知された。

以上のように、2月の AIIM ML は NIST-2025-0035 回答文書のレビューと MCP × AuthZen に関する議論を中心に展開されていた。
...
- [GitHub wiki ホーム（ミーティングノート一覧含む）](https://github.com/openid/cg-ai-identity-management/wiki) — 2026-02-12・2026-02-26 のミーティングノートへのリンク（ノート本文は CG 方針に沿って非公開）
...
- [openid-aiim ML アーカイブ（2026-02-16 週）](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260216/) — NIST フィードバック議論・MCP profile of AuthZen コール・COAZ スライド共有
- [openid-aiim ML アーカイブ（2026-02-23 週）](https://lists.openid.net/pipermail/openid-aiim/Week-of-Mon-20260223/) — NIST フィードバック継続・サブグループ招待・AI セキュリティカンファレンス告知
- [openid-aiim ML アーカイブ（全期間）](https://lists.openid.net/pipermail/openid-aiim/) — 週別インデックス
