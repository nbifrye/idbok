...
2026年1月は、AB/Connect WG にとって**複数の重要な仕様進捗が集中した活動的な月**であった。**OpenID Connect Native SSO for Mobile Apps 1.0 が Implementer's Draft として承認**（1月6日）されたほか、**OpenID Federation Subordinate Events Endpoint 1.0 初期ドラフト公開**（1月9日）、**OpenID Connect RP Metadata Choices 1.0 の Final Specification 公開レビュー開始**（1月9日）と立て続けに進展があった。さらに月末には **OpenID Federation 1.0 Final Specification 投票通知**（1月20日）が出され、後継版となる **1.1 系仕様群の初期 Editor's Draft** も公開された。

対象月の主要トピック:

- OpenID Connect Native SSO for Mobile Apps 1.0 Implementer's Draft 承認（1月6日）
...
### OpenID Connect Native SSO for Mobile Apps 1.0 Implementer's Draft 承認

**承認日: 2026年1月6日**、投票結果は承認 57 票。
...
現行ドラフト（Draft 07）は安定した実装版として公開されているが、1月時点の WG 内では「このまま最終化するか、DPoP バインディングを `device_secret` に追加してから最終化するか」という技術的検討が続いていた。
...
- [Implementer's Draft of OpenID Connect Native SSO for Mobile Apps Approved](https://openid.net/implementers-draft-of-openid-connect-native-sso-for-mobile-apps-approved/) — 1月6日承認告知
