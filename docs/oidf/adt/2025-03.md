...
2025 年 3 月の ADT CG は、**2 月の CG 立ち上げ直後の運用整備フェーズから、サブグループ別の実作業フェーズへと移行を始めた月**である。メイン会合では、(a) Age Verification サブグループの名称を **Age Assurance** へ正式変更（議論を 3 月 10 日に行い、Slack での確認を経て PR #5 と 3 月 30 日のディレクトリリネーム作業に結実）、(b) SIDI Trust Framework Analysis（TFA）サブグループの正式キックオフ準備（3 月 27 日に Dave Hyland が TFA Readme を更新し、隔週月曜 17:00 AEDT・3 月 31 日初回開催を明文化）、(c) Linden Dawson による DADE AU サブグループ案の正式提起、(d) John Phillips による UN/CEFACT Recommendation 49 / UNTP / Global Trust Registry の継続的な情報共有、(e) Jon Dart（CBA）による「business identity」議題の持ち込み、といった構造形成の議論が連続した。
...
なお、3 月 30 日に Victoria Richardson によって新規作成された `AgeAssertion/README.md`（コミット `c15564e`）は本文が `# Age Assertion` の 1 行のみで、Innovation Day 向けの具体的アウトラインは 4 月 1 日のディレクトリリネーム時に拡充される。本月時点の Age Assurance サブグループは「名称が定まった」段階にあり、内容物の整備は翌月に持ち越された。
...
- **John Phillips による UN/CEFACT GTR / UNTP の紹介（重要）**: 議事録引用:
  ...
  「別セッションで継続議論」と合意され、4 月以降の UNTP / GTR 追跡の起点となった。Recommendation 49 Public Review 2 は 4 月 23 日が期限で、ADT CG メンバー個人としての関与が示唆された。
...
- **UN/CEFACT Recommendation 49 / UNTP / Global Trust Registry**: 4 月 23 日 Public Review 2 終了後の UN 側の動きと、John Phillips リード予定の GTR ワークの立ち上げ準備を継続注視
