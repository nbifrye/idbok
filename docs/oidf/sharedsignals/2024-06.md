...
- **3 仕様の OIDF Secretary 提出完了**: コール直後の ML 投稿 [001612](https://lists.openid.net/pipermail/openid-specs-risc/Week-of-Mon-20240617/001612.html) で Atul が **「I sent in our specs to the Secretary, to begin the review」** と報告。提出された 3 仕様は SSF Draft 03 / CAEP Draft 04 / CAEP Interoperability Profile Draft 01 として通告された（実際の Public Review では各仕様の Draft 番号は SSF 03 / CAEP 03 / Interop 00 として再整理される）
...
| [Week-of-Mon-20240617](https://lists.openid.net/pipermail/openid-specs-risc/Week-of-Mon-20240617/thread.html) |      8 | GitHub bot 通知 3 件（Issue #186 起票・comment 2 件）、Atul の 6/18 Update on new drafts + Michael Jones 返信、WG コール招待更新 3 件                                    |
