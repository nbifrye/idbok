...
- [ML アーカイブ: openid-specs-digital-credentials-protocols](https://lists.openid.net/pipermail/openid-specs-digital-credentials-protocols/) - 週次（Week-of-Mon）単位のアーカイブインデックス
